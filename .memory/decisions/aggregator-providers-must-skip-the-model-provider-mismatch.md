...
- [gotcha] Known dormant overlays as of 2026-07-04: `lmstudio` and `tencent-tokenhub` are now in models.dev, so their overlayOnlyProviders entries are inert fallback — harmless, candidates for cleanup on the next catalog pass. #gotcha
