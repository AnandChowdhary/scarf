...
---
_Last updated: 2026-06-28 — Scarf v2.15.0 (Projects grow up: first-class project object + cockpit, mini-apps, fleet/portfolio, one-click Upgrade Project, project chats load AGENTS.md). Note: the "Targets Hermes" line below predates this release and still reflects v0.15 — v2.15.0 is a Projects feature release and does not change the Hermes target (v0.17)._